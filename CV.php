	...
	<section class="about-section section">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-12 col-md-9 cv" style="display: flex;flex-direction: row;">
                                    
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                          <h5 class="card-title">CV français</h5>
                          <p class="card-text"><br></p>
                          <a href="cv/CV_FR.pdf" class="btn btn-primary">Télécharger</a>
                        </div>
                      </div>

                      <div class="card" style="width: 18rem;">
                        <div class="card-body">
                          <h5 class="card-title">CV canadien</h5>
                          <p class="card-text">rédigé en français</p>
                          <a href="cv/CV_CA_FR.pdf" class="btn btn-primary">Télécharger</a>
                        </div>
                      </div>
                      ...
                      <div class="card" style="width: 18rem;">
                        <div class="card-body">
                          <h5 class="card-title">CV canadien</h5>
                          <p class="card-text">rédigé en anglais</p>
                          <a href="cv/CV_CA_EN.pdf" class="btn btn-primary">Télécharger</a>
                        </div>
                      </div>
